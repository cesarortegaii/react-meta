import { getContributingContent } from '@/lib/docs';
...
export default async function ContributingPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0A0A0A] text-neutral-200 selection:bg-blue-500/30">
            <Title>Contributing | react-meta-seo</Title>
            <Meta name="description" content="Learn how to contribute to react-meta-seo. Development setup, workflow guidelines, and code standards." />
                        ...
                        <div className="sticky top-24 space-y-6">
                            <div className="rounded-xl border border-white/5 bg-white/[0.02] p-6 backdrop-blur-sm">
                                ...
                                <p className="text-sm text-neutral-400">
                                    We welcome contributions! Follow the guidelines to get started.
                                </p>
                            </div>

                            <div className="rounded-xl bg-gradient-to-br from-green-600 to-emerald-600 p-6 text-white shadow-2xl shadow-green-900/20">
                                <h3 className="font-bold text-lg mb-2">Ready to contribute?</h3>
                                <p className="text-green-100 text-sm mb-4">Fork the repository and start building!</p>
                                <div className="bg-white/10 rounded-lg p-2 font-mono text-xs flex items-center justify-between cursor-pointer hover:bg-white/20 transition-colors">
                                    <span>git clone react-meta</span>
                                </div>
                            </div>
                        </div>
                    </aside>
