import { getMigrationContent } from '@/lib/docs';
...
export default async function MigrationPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0A0A0A] text-neutral-200 selection:bg-blue-500/30">
            <Title>Migration Guide | react-meta-seo</Title>
            <Meta name="description" content="Step-by-step guide to migrate from react-helmet to react-meta-seo. Upgrade to React 19 native metadata hoisting." />
                        ...
                        <div className="sticky top-24 space-y-6">
                            <div className="rounded-xl border border-white/5 bg-white/[0.02] p-6 backdrop-blur-sm">
                                ...
                                <p className="text-sm text-neutral-400">
                                    Upgrade from react-helmet to native React 19 metadata in minutes.
                                </p>
                            </div>

                            <div className="rounded-xl bg-gradient-to-br from-orange-600 to-red-600 p-6 text-white shadow-2xl shadow-orange-900/20">
                                <h3 className="font-bold text-lg mb-2">60-Second Migration</h3>
                                <p className="text-orange-100 text-sm mb-4">Follow the step-by-step guide to upgrade quickly.</p>
