import { getChangelogContent } from '@/lib/docs';
...
export default async function ChangelogPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0A0A0A] text-neutral-200 selection:bg-blue-500/30">
            <Title>Changelog | react-meta-seo</Title>
            <Meta name="description" content="Version history and release notes for react-meta-seo. Track new features, improvements, and bug fixes." />
